...
namespace WiT_PluginSDK
{
    public partial class MainForm : Form
    {
        ...
        void созданиеБиблиотекиПлагинаToolStripMenuItem_Click(object sender, EventArgs e) { try { Process.Start("https://teletype.in/@zalexanninev15/wit3_create_plugin_pluginapi_1.0"); } catch { MessageBox.Show("Браузер по умолчанию не найден, поэтому сслылка скопирована в буфер обмена!", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning); Clipboard.SetText("https://teletype.in/@zalexanninev15/wit3_create_plugin_pluginapi_1.0"); } }
